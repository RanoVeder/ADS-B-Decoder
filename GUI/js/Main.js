...
function Add_Plane(str){
  ...
  html = '<div class="aircraft" id="'+counter+'"><div class="aircraft_icon"><img src="img/airplane1.png"></div><div class="aircraft_info"><span class="ICAO">' +str.ICAO + '</span><span class="ALT">Altidude: '+str.ALT+' ft</span><span class="Speed">Speed: ' +str.Speed+' knts</span></div></div>'      
   	$('.aircraft_container').append(html);
   	console.log(str.Lat,str.Lon)
...
function Update_Plane(str){
  console.log("hee")
  console.log(list[str.ICAO24])
	html = '<div class="aircraft" id="'+list[str.ICAO24]+'"><div class="aircraft_icon"><img src="img/airplane1.png"></div><div class="aircraft_info"><span class="ICAO">' +str.ICAO + '</span><span class="ALT">Altidude: '+str.ALT+' ft</span><span class="Speed">Speed: ' +str.Speed+' knts</span></div></div>'      
	$('#'+list[str.ICAO24]).html(html);
	console.log(str.Lat,str.Lon)
	if(str.Lat != 0  && str.Lon !=0){
   		Update_Marker(str);
	}
